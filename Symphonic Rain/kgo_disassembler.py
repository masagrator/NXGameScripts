...
for y in range(0, len(files)):
	...
	for i in range(0, registration_entries):
		...
		entry["DATE_START"] = int.from_bytes(file.read(0x2), byteorder="little")
		entry["HOUR_START"] = int.from_bytes(file.read(0x2), byteorder="little")
		entry["DATE_END"] = int.from_bytes(file.read(0x2), byteorder="little")
		entry["HOUR_END"] = int.from_bytes(file.read(0x2), byteorder="little")
