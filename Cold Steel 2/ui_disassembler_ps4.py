		...
		case 0x13:
			...
			match(entry["CONTROL"]):
				...
				case 1:
					entry["UNK0"] = file.read(1).hex().upper()
				case 0xA:
					entry["UNK0"] = file.read(36).hex().upper()
				case 0xB:
					entry["UNK0"] = file.read(6).hex().upper()
					entry["STRINGS"] = [readString(file)]
					entry["UNK1"] = file.read(15).hex().upper()
				case 0xC:
					entry["UNK0"] = file.read(35).hex().upper()
				case 0xE:
					entry["UNK0"] = file.read(19).hex().upper()
				case 0xF:
					entry["UNK0"] = file.read(20).hex().upper()
				case 0x10:
					entry["UNK0"] = file.read(31).hex().upper()
				case 0x11:
					entry["UNK0"] = file.read(18).hex().upper()
				case 0x12:
					entry["UNK0"] = file.read(36).hex().upper()
				case 0x13:
					entry["UNK0"] = file.read(27).hex().upper()
				case 0x14:
					entry["UNK0"] = file.read(18).hex().upper()
				case 0x15:
					entry["UNK0"] = file.read(22).hex().upper()
				case 0x16:
					entry["UNK0"] = file.read(23).hex().upper()
				case 0x17:
					entry["UNK0"] = file.read(21).hex().upper()
				case 0x18:
					entry["UNK0"] = file.read(19).hex().upper()
				case 0x19:
					entry["UNK0"] = file.read(21).hex().upper()
				...
				case 0x28:
					entry["UNK0"] = file.read(21).hex().upper()
				case 0x29:
					entry["UNK0"] = file.read(39).hex().upper()
				case 0x2A:
					entry["UNK0"] = file.read(20).hex().upper()
				case 0x2B:
					entry["UNK0"] = file.read(6).hex().upper()
				...
				case _:
					...
					elif (entry["CONTROL"] in [0x1A, 0x1B]):
						entry["UNK0"] = file.read(20).hex().upper()
					elif (entry["CONTROL"] in [0x1E, 0x1F, 0x20]):
						entry["UNK0"] = file.read(21).hex().upper()
					elif (entry["CONTROL"] in [0x2F, 0x30]):
						entry["UNK0"] = file.read(19).hex().upper()
...
for y in range(0, len(files)):
	...
	file = open("jsons/%s.json" % files[y][4:-4], "w", encoding="UTF-8")
